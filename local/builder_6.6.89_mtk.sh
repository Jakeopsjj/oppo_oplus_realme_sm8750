...
# ===== 启用fanotify完整支持 =====
echo ">>> 正在启用fanotify完整支持..."
# fanotify核心配置
echo "CONFIG_FANOTIFY=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_FANOTIFY_ACCESS_PERMISSIONS=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_FANOTIFY_ERROR_REPORTING=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_FANOTIFY_MARK_SID=y" >> "$DEFCONFIG_FILE"
# fanotify依赖配置
echo "CONFIG_FSNOTIFY=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_AUDIT=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_AUDITSYSCALL=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_SECURITY=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_SECURITY_FS_USE_XATTR=y" >> "$DEFCONFIG_FILE"
# 相关通知配置
echo "CONFIG_DNOTIFY=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_INOTIFY_USER=y" >> "$DEFCONFIG_FILE"
echo "CONFIG_FHANDLE=y" >> "$DEFCONFIG_FILE"
